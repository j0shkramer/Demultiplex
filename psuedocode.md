...
- Create two lists to store the header, sequence, plus line, and quality scores of the Read1,2,3,4 files: read1_list, read2_list, read3_list, read4_list
...
- Print out to terminal how many times each indexes had matches, swaps, or were unknown
- Create a graph showing index matches
